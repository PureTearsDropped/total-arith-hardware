...
for TL in gate9 compress3 sd_add2 sd_mult10 pe24 barrel18 blocknorm sed_comp bin_mult11 bin_mult11_ks bin_mac11 bin_blocknorm bin_sed_comp quat_unit bin_quat_unit; do
